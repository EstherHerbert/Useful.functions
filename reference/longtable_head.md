...
Format header information from an xtable for adding to the printed
...
- add.to.caption:
  ...
  Text to be added to all but the last captions, default is "
  (continued)".

- footnote:

  Text to be added to the footnote of all but the last page, default is
...
- pos:
  ...
  position in table to insert the header commands, default is 0. Use 1
  if double header is`TRUE`
...
#> % Tue Nov 18 16:59:19 2025
#> \begin{longtable}{rrrrrl}
#>   \hline
#>  & Sepal.Length & Sepal.Width & Petal.Length & Petal.Width & Species \\ 
#>   \endfirsthead
#> \caption[]{Iris Data (continued)}\\
#> \hline
#> Sepal.Length & Sepal.Width & Petal.Length & Petal.Width & Species \\
#> \hline
#> \endhead
